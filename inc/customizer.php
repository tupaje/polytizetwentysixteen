<?php
/**
 * Polytize Twenty Sixteen Customizer functionality
 *
 * @package WordPress
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in Polytize Twenty Sixteen.
	 *
	 * @since Polytize Twenty Sixteen 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in Polytize Twenty Sixteen.
	 *
	 * @since Polytize Twenty Sixteen 1.0
	 *
	 * @param array $args {
...
function twentysixteen_header_style() {
	...
	?>
	<style type="text/css" id="polytizetwentysixteen-header-css">
		.site-branding {
			margin: 0 auto 0 0;
		}
...
function twentysixteen_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'polytizetwentysixteen' ),
		'section'  => 'colors',
		'type'     => 'select',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'page_background_color', array(
		'label'       => __( 'Page Background Color', 'polytizetwentysixteen' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color', array(
		'label'       => __( 'Link Color', 'polytizetwentysixteen' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'main_text_color', array(
		'label'       => __( 'Main Text Color', 'polytizetwentysixteen' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'secondary_text_color', array(
		'label'       => __( 'Secondary Text Color', 'polytizetwentysixteen' ),
		'section'     => 'colors',
	) ) );
}
...
/**
 * Registers color schemes for Polytize Twenty Sixteen.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Polytize Twenty Sixteen.
	 *
	...
	return apply_filters( 'twentysixteen_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'polytizetwentysixteen' ),
			'colors' => array(
				'#1a1a1a',
				'#ffffff',
				'#007acc',
		...
		'dark' => array(
			'label'  => __( 'Dark', 'polytizetwentysixteen' ),
			'colors' => array(
				'#262626',
				'#1a1a1a',
				'#9adffd',
		...
		'gray' => array(
			'label'  => __( 'Gray', 'polytizetwentysixteen' ),
			'colors' => array(
				'#616a73',
				'#4d545c',
				'#c7c7c7',
		...
		'red' => array(
			'label'  => __( 'Red', 'polytizetwentysixteen' ),
			'colors' => array(
				'#ffffff',
				'#ff675f',
				'#640c1f',
		...
		'yellow' => array(
			'label'  => __( 'Yellow', 'polytizetwentysixteen' ),
			'colors' => array(
				'#3b3721',
				'#ffef8e',
				'#774e24',
...
/**
 * Retrieves the current Polytize Twenty Sixteen color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for Polytize Twenty Sixteen.
 *
...
/**
 * Handles sanitization for Polytize Twenty Sixteen color schemes.
 *
...
function twentysixteen_color_scheme_css() {
	...
	wp_add_inline_style( 'polytizetwentysixteen-style', $color_scheme_css );
}
...
function twentysixteen_customize_preview_js() {
	wp_enqueue_script( 'polytizetwentysixteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20150922', true );
}
...
function twentysixteen_color_scheme_css_template() {
	...
	?>
	<script type="text/html" id="tmpl-polytizetwentysixteen-color-scheme">
...
function twentysixteen_page_background_color_css() {
	...
	wp_add_inline_style( 'polytizetwentysixteen-style', sprintf( $css, $page_background_color ) );
}
...
function twentysixteen_link_color_css() {
	...
	wp_add_inline_style( 'polytizetwentysixteen-style', sprintf( $css, $link_color ) );
}
...
function twentysixteen_main_text_color_css() {
	...
	wp_add_inline_style( 'polytizetwentysixteen-style', sprintf( $css, $main_text_color, $border_color ) );
}
...
function twentysixteen_secondary_text_color_css() {
	...
	wp_add_inline_style( 'polytizetwentysixteen-style', sprintf( $css, $secondary_text_color ) );
}
